...
proc_name="acore_validator"
vali_name="acore_v_endpoint"
args=()
version_location="./acore/__init__.py"
version="__version__"
...
if [ "$?" -eq 1 ]; then
    ...
    while true; do
        ...
        if [ -d "./.git" ]; then
            ...
            latest_version=$(check_variable_value_on_github "acoreai-dev/acoreai-subnet" "acoreai/__init__.py" "__version__ " "$branch")
            ...
            if version_less_than $current_version $latest_version; then
                ...
                if git pull origin $branch; then
                    ...
                    # pm2 del acoreai_validator_autoupdate
