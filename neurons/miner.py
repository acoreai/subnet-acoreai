...
from acoreai.base.miner import BaseMinerNeuron
from acoreai.protocol import NATextSynapse, NAImageSynapse, NAStatus
from acoreai.miner.utils import set_status, check_status, generate, check_validator
...
class Miner(BaseMinerNeuron):
    ...
    async def forward_image(
        ...
        Args:
            synapse (acoreai.protocol.NAImageSynapse): The synapse object containing the 'NAImageSynapse_input' data.

        Returns:
            acoreai.protocol.NAImageSynapse: The synapse object with the 'NAImageSynapse_output' field set to twice the 'NATextSynapse_input' value.
